...
async function main() {
  ...
  for (let index = 0; index < sourceItems.length; index += 1) {
    ...
    outputItems.push({
      ...
      editorialAlert: source.editorialAlert || source.alert || source.alertaEditorial || source.observacoesEditoriais || "",
      dataDoFato: source.dataDoFato || "",
      fatoNovo: source.fatoNovo || "",
